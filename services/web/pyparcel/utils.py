"""
Miscellaneous code to be used in the creation of this package.
"""
import itertools
...
from pyparcel.common import SPAN, PARCEL_ID_LoB, OWNER, TAXINFO
...
# Todo: Discuss merits of permanent calls to the pickler left in source code with
#  @click.option(--pickle/--nopickle)
def pickler(obj, filename, path_to_file=MOCKS, incr=True, to_type=None):
    ...
    Args:
        to_type:
            Defaults to None.
            Leaving it as is pickles the object, otherwise it writes the file type.
...
def replace_taxstatus(taxes, soup, r) -> bs4.BeautifulSoup:
    """
    """
    # Setup: We want taxes to be a list of at least 4 TaxStatuses or Nones,
    # but we accept any number, including a single TaxStatus instance
