...
Home for Magic Strings and classes that are used across different files.
    ...
    Likewise, the class EventDetails resides in events.py
    because its usage is strongly tied to events.
"""

# Note: Some Magic Strings are currently unused, but kept anyways for potential use
...
# Database attributes
BOT_ID = "99"
BOT_NAME = os.environ.get("POSTGRES_USER")
BOT_PASSWORD = os.environ.get("POSTGRES_PASSWORD")
