...
from pyparcel.common import SPACE
...
def property_insertmap(r: dict) -> dict:
    """
    Arguments:
        r: The dictionized JSON record for a parcel id provided by the WPRDC
    Returns:
        dict
    """
    imap = {}
    ...
    imap["usegroup"] = r[
        "USEDESC"
    ]  # ? I THINK this is what we want? Example, MUNICIPAL GOVERNMENT.
...
def owner_imap(name, r):
    ...
    imap[
        "notes"
    ] = "In case of confusion, check automated record entry with raw text from the " \
        "county database. "
